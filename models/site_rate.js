...
module.exports.push_rates = function(
  device_ids,
  employee_ids,
  all_rates,
  callback
  ...
  var cus_emp_rates = all_rates.filter(function(rate) {
    return !device_ids.some(function(device_id) {
      return device_id == rate.customer_id;
    });
  });
  ...
  var rates = cus_emp_rates.filter(function(rate) {
    return !employee_ids.some(function(device_id) {
      return device_id == rate.customer_id;
    });
  });
      ...
      function(err, rate_to_update) {
        ...
        if (rate_to_update.length == 0) {
          ...
          rate_to_update.forEach(function(rateObj) {
            ...
            var transaction =
              rate.transaction == true ? true : rateObj.transaction;
...
module.exports.get_stats = function(site, start, end, callback) {
  ...
  Rate.find(
    { site: site, position: 1, date: { $gte: start, $lte: end } },
    callback
  );
};
...
module.exports.get_total_rates_for_range = function(
  site,
  start,
  end,
  callback
...
module.exports.get_total_impressions_for_range = function(
  site,
  start,
  end,
  callback
